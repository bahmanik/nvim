...
vim.keymap.set('i', '<C-j>', '<Esc>:m .+1<CR>gv=gv')
vim.keymap.set('i', '<C-j>', '<Esc>:m .+1<CR>gv=gv')

-- keeping the curser at middle when searching
vim.keymap.set('n', 'N', 'Nzzzv')
vim.keymap.set('n', 'n', 'nzzzv')

-- paste to replace word
vim.keymap.set('x', '<leader>p', '"_dhp')
-- paste to replace word under courser
vim.keymap.set('n', '<leader>r', 'viw"_dhp')
